...
type Stats = { total:number; stages:Record<string,number>; concerns:Record<string,number>; royalUsage:Record<string,number>; segments:Record<string,number> };
...
const fallbackStats:Stats={total:0,stages:{'幼年期（1岁以内）':0,'成年期（1–7岁）':0,'老年期（7岁以上）':0},concerns:{},royalUsage:{},segments:{}};
